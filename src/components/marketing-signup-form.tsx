    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="ring-2 ring-accent/ shadow-xl bg-card text-card-foreground">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Create Marketing Account</CardTitle>
          <CardDescription>
            Join as a marketer and manage advertising campaigns
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form>
            <div className="grid gap-6">
              ...
              <div className="text-center text-sm">
                Already have a Marketing account?{" "}
                <Link href="/marketing/login" className="underline underline-offset-4">
                  Sign in
                </Link>
              </div>
